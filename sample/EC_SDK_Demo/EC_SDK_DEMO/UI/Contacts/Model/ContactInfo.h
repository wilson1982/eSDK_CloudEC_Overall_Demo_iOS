...
/**
 This method is used to transform TUP_EADDR_S_CONTACTOR_INFO data to ContactInfo data

 @param info TUP_EADDR_S_CONTACTOR_INFO
 @return ContactInfo
 */
+ (ContactInfo *)contactInfoTransformFrom:(TUP_EADDR_S_CONTACTOR_INFO)info;
