...
-(void)setCancelIPTService
{
    ...
    // TODO: CHENZHIQIAN
//    [[ManagerService callService] setIPTService:CALL_E_SERVICE_CALL_TYPE_UNREG_DND number:@""];
//    [[ManagerService callService] setIPTService:CALL_E_SERVICE_CALL_TYPE_CALL_WAIT_DEACTIVE number:@""];
//    [[ManagerService callService] setIPTService:CALL_E_SERVICE_CALL_TYPE_FORWARD_UNCONDITION_Deactive number:@""];
//    [[ManagerService callService] setIPTService:CALL_E_SERVICE_CALL_TYPE_FORWARD_ONBUSY_Deactive number:@""];
//    [[ManagerService callService] setIPTService:CALL_E_SERVICE_CALL_TYPE_FORWARD_NOREPLY_Deactive number:@""];
//    [[ManagerService callService] setIPTService:CALL_E_SERVICE_CALL_TYPE_FORWARD_OFFLINE_Deactive number:@""];
