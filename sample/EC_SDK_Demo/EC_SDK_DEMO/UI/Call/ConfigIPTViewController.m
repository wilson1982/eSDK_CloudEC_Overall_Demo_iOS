...
- (IBAction)dndSwitchAction:(id)sender
{
    ...
    if (swtich.on)
    {
        result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_REG_DND number:@""];
    }
    else
    {
        result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_UNREG_DND number:@""];
    }
    if (!result)
    {
...
- (IBAction)cfuSwitchAction:(id)sender
{
    ...
    if (isNumberNotEmpty)
    {
        ...
        if (swtich.on)
        {
            result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_FORWARD_UNCONDITION_Active number:_cfuNumberTextField.text];
        }
        else
        {
            result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_FORWARD_UNCONDITION_Deactive number:_cfuNumberTextField.text ];
        }
        if (!result)
        {
            [self showMessage:@"fail"];
...
- (IBAction)cfbSwitchAction:(id)sender
{
    ...
    if (isNumberNotEmpty)
    {
        ...
        if (swtich.on)
        {
            result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_FORWARD_ONBUSY_Active number:_cfbNumberTextField.text ];
        }
        else
        {
            result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_FORWARD_ONBUSY_Deactive number:_cfbNumberTextField.text ];
        }
        if (!result)
        {
            [self showMessage:@"fail"];
...
- (IBAction)cfnaSwitchAction:(id)sender
{
    ...
    if (isNumberNotEmpty)
    {
        ...
        if (swtich.on)
        {
            result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_FORWARD_NOREPLY_Active number:_cfnaNumberTextField.text];
        }
        else
        {
            result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_FORWARD_NOREPLY_Deactive number:_cfnaNumberTextField.text];
        }
        if (!result)
        {
            [self showMessage:@"fail"];
...
- (IBAction)cfnrSwitchAction:(id)sender
{
    ...
    if (isNumberNotEmpty)
    {
        ...
        if (swtich.on)
        {
            result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_OFFLINE_Active number:_cfnrNumberTextField.text ];
        }
        else
        {
            result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_OFFLINE_Deactive number:_cfnrNumberTextField.text ];
        }
        if (!result)
        {
...
- (IBAction)callWaitSwitchAction:(id)sender
{
    ...
    if (swtich.on)
    {
        result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_CALL_WAIT_Active number:@""];
    }
    else
    {
        result = [[ManagerService callService] setIPTService:CALL_SERVICE_TYPE_CALL_WAIT_Deactive number:@""];
    }
    if (!result)
    {
        [self showMessage:@"Config failed!"];
...
-(IPTConfig *)getCurrentAccountIptStatus
{
    ...
    for (NSDictionary *tempDic in orginalArray)
    {
        ...
        if ([account isEqualToString:mineLoginInfo.account])
        {
