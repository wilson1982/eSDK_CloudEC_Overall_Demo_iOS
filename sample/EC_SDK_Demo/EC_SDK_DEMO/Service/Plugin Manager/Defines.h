...
extern NSString *const TUP_CALL_HOLD_RESULT_KEY;        // value: BOOL
extern NSString *const TUP_CALL_UNHOLD_RESULT_KEY;      // value: BOOL
extern NSString *const TUP_CALL_TRANSFER_RESULT_KEY;    // value: BOOL
...
//CTD
extern NSString *const TUP_CTD_CALL_RESULT_KEY;
extern NSString *const TUP_CTD_CALL_STATE_KEY;
//conf id
...
typedef NS_ENUM(NSUInteger, CALL_SERVICE_TYPE) {
    CALL_SERVICE_TYPE_REG_DND = 1,
    CALL_SERVICE_TYPE_UNREG_DND = 2,
    CALL_SERVICE_TYPE_CALL_WAIT_Active = 3,
    CALL_SERVICE_TYPE_CALL_WAIT_Deactive = 4,
    CALL_SERVICE_TYPE_FORWARD_UNCONDITION_Active = 25,
    CALL_SERVICE_TYPE_FORWARD_UNCONDITION_Deactive,
    CALL_SERVICE_TYPE_FORWARD_ONBUSY_Active,
    CALL_SERVICE_TYPE_FORWARD_ONBUSY_Deactive,
    CALL_SERVICE_TYPE_FORWARD_NOREPLY_Active,
    CALL_SERVICE_TYPE_FORWARD_NOREPLY_Deactive,
    CALL_SERVICE_TYPE_OFFLINE_Active,
    CALL_SERVICE_TYPE_OFFLINE_Deactive
};
