...
@interface ContactNotification : NSObject
@property (nonatomic, assign) TUP_EADDR_E_RESULT_OPER_ID msgId;  // the message ID
@property (nonatomic, assign) void* data;                        // the msg content

/**
 * This method is used to init data ContactNotification
 * 初始化ContactNotification
 *@param msgId TUP_EADDR_E_RESULT_OPER_ID
 *@param data void*
 *@return ContactNotification
 */
- (id)initWithContactMsgId:(TUP_EADDR_E_RESULT_OPER_ID)msgId
                      data:(void*)data;
@end
